...
describe("calculateSupertrendSeriesData", () => {
  test("aligns SuperTrend outputs to the original candle index after the period offset", () => {
    const candles = [
      { time: at(1704067200), open: 98, high: 100, low: 95, close: 98, volume: 1000 },
      { time: at(1704153600), open: 101, high: 102, low: 96, close: 101, volume: 1000 },
      { time: at(1704240000), open: 104, high: 105, low: 99, close: 104, volume: 1000 },
      { time: at(1704326400), open: 101, high: 108, low: 100, close: 101, volume: 1000 },
      { time: at(1704412800), open: 109, high: 110, low: 104, close: 109, volume: 1000 },
      { time: at(1704499200), open: 113, high: 114, low: 108, close: 113, volume: 1000 },
    ];
